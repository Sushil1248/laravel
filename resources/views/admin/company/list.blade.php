                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="purchase-order-date">
                                        @can('user-view')
                                        <a href="#" class="open-section get-company-detail" data-target="company-details" data-user-id="{{ jsencode_userdata($singleCompany->id) }}">{{ $singleCompany->company_name }}</a>
                                        @else
                                        {{ $singleCompany->company_name }}
                                        @endcan
                                    </td>
                                    <td class="purchase-order-date">
                                        {{ $singleCompany->company_email }}
                                    </td>
                                    <td class="purchase-order-date">
                                        {{ $singleCompany && $singleCompany->contact_person ? ucfirst($singleCompany->contact_person) : 'NA' }}
                                    </td>
                                    <td>
                                        {{ $singleCompany && $singleCompany->contact_number ? $singleCompany->contact_number : 'NA' }}
                                    </td>
                            ...
                            <tbody>
                                @isset($deletedCompanies)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $singleCompany && $singleCompany->contact_person ? $singleCompany->contact_person : 'NA' }}
                                        </td>
                                        <td>
                                            {{ $singleCompany && $singleCompany->contact_number ? $singleCompany->contact_number : 'NA' }}
                                        </td>
