    ...
    <div class="container">
        <div class="left-content d-flex">
            <div class="list-title d-flex">
                ...
                <div class="list-content">
                    <h2 class="heading-text">Subscription Payments</h2>
                    <h2 class="mobile-text d-none">Subscription Payments</h2>
                    <p>
                        View details
                    </p>
                </div>
        ...
        <div class="order-listing Invoice-tabs">
            ...
            <ul class="tabs nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">All Subscription Payments</a>
                </li>
            </ul>
            ...
            <div class="tab-content invoice-tab-content">
                ...
                <div class="tab-pane active" id="tabs-1" role="tabpanel">
                    @include('admin.payment.table-list')
                </div>
...
<script>
    ...
    $("#create-cms-page-form").validate({
        ...
        messages:{
            name:{
                required:"Subscription Payments name is required"
            }
        },
