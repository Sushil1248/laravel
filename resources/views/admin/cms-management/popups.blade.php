...
<!-- Create popup -->
<div class="filter-sidebar filter-side-drawer order-sidebar create-module" id="create-cms-page" data-page-refresh="0">
    <div class="filter-listing">
        <form method="post" action="{{ route('cms-management.add') }}" id="create-cms-page-form" enctype="multipart/form-data">
        @csrf
                    ...
                    <ul style="grid-template-columns: 1fr 2fr 3fr;">
                        <li>
                            ...
                            <div class="input-group input-group-sm invoice-value">
                                <input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Page name" name="name"> 
                            </div>
                        </li>
                        ...
                        <li>
                            <p>Short Content</p>
                            <div class="input-group input-group-sm invoice-value">
                                <textarea type="text" class="form-control comment-box" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Short content" name="short_content"></textarea>
                            </div>
                        </li>
                        <li>
                            <p>Content</p>
                            <div class="input-group input-group-sm invoice-value">
                                <textarea type="text" class="form-control comment-box" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Content" name="content"></textarea>
                            </div>
                        </li>
                    </ul>
                    <x-media-files/>
