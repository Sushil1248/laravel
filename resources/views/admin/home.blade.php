            ...
            <div class="col-xl-3 col-md-6 mb-4 mt-4">
                <div class="card h-100 totalCard" data-open-url="">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-uppercase mb-1">Active Companies</div>
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $activeCompanies }}</div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4 mt-4">
                <div class="card h-100 totalCard" data-open-url="">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-uppercase mb-1">Active Devices</div>
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $activeDevices }}</div>
                            </div>
                            <div class="col-auto">
...
// Create c_root element
// https://www.amcharts.com/docs/v5/getting-started/#Root_element
var c_root = am5.Root.new("companyChartdiv");

// Set themes
// https://www.amcharts.com/docs/v5/concepts/themes/
c_root.setThemes([
  am5themes_Animated.new(c_root)
]);

// Create chart
// https://www.amcharts.com/docs/v5/charts/xy-chart/
var chart = c_root.container.children.push(am5xy.XYChart.new(c_root, {
  panX: true,
  panY: true,
  wheelX: "panX",
  wheelY: "zoomX",
...
// Add cursor
// https://www.amcharts.com/docs/v5/charts/xy-chart/cursor/
var cursor = chart.set("cursor", am5xy.XYCursor.new(c_root, {}));
cursor.lineY.set("visible", false);

// Create axes
// https://www.amcharts.com/docs/v5/charts/xy-chart/axes/
var xRenderer = am5xy.AxisRendererX.new(c_root, { minGridDistance: 30 });
xRenderer.labels.template.setAll({
  rotation: -90,
  centerY: am5.p50,
  centerX: am5.p100,
...
var xAxis = chart.xAxes.push(am5xy.CategoryAxis.new(c_root, {
  maxDeviation: 1,
  categoryField: "statistics",
  renderer: xRenderer,
  tooltip: am5.Tooltip.new(c_root, {})
}));

var yAxis = chart.yAxes.push(am5xy.ValueAxis.new(c_root, {
  maxDeviation: 1,
  renderer: am5xy.AxisRendererY.new(c_root, {})
}));


// Create series
// https://www.amcharts.com/docs/v5/charts/xy-chart/series/
var series = chart.series.push(am5xy.ColumnSeries.new(c_root, {
  name: "Series 1",
  xAxis: xAxis,
  yAxis: yAxis,
  valueYField: "value",
...
// Set data
var data = [{
  statistics: "Total Companies",
  value: {{ $totalCompanies }}
}, {
  statistics: "Active Companies",
